...
public class UpdateRemovalRequest extends JFrame {

	private static final long serialVersionUID = 1L;
	

    private JLabel title,lblFName,lblLName,lblPhone,lblAddress,lblPay,lblId,lblOutcome,lblInterNo;
    private JTextField txtFName,txtLName,txtPhone,txtAddress,txtId,txtInterNo;
    ...
    private JButton findBtn,resetBtn,updateBtn;
	...
	public UpdateRemovalRequest() {
    	...
    	title = new JLabel("Update Removal Request");
    	...
    	lblInterNo = new JLabel("Invervention # : ");
    	lblInterNo.setForeground(Color.WHITE);
    	lblInterNo.setFont(labelFont);
    	lblInterNo.setBounds(900,400,500,40);
    	add(lblInterNo);
    	
    	txtInterNo = new JTextField();
    	txtInterNo.setFont(new Font("Tahoma", Font.PLAIN, 30));
    	txtInterNo.setToolTipText("Intervention number");
    	txtInterNo.setEditable(false);
    	txtInterNo.setBounds(900,500,400,50);
    	add(txtInterNo); 
    	...
    	updateBtn.setBounds(1300,1000,200,65);
    	...
    	findBtn.addActionListener(new ActionListener() 
    	{
    		 public void actionPerformed(ActionEvent ae)
    		 {
               ...
               try 
               {
    			   ...
    			   cmbOutcome.setSelectedItem(removal.getOutcome());
    			   txtInterNo.setText(removal.getInterventionNo());
    	...
    	updateBtn.addActionListener(new ActionListener() {
    		public void actionPerformed(ActionEvent action)
    		{
    			   try 
                   {
        			   ...
        			   removal.getDate().setMonth(Integer.parseInt(txtMonth.getText()));
        			   removal.getDate().setDay(Integer.parseInt(txtDay.getText()));
        			   removal.getDate().setYear(Integer.parseInt(txtYear.getText()));
        			   removal.getTime().setMinutes(Integer.parseInt(txtMinutes.getText()));
        			   removal.getTime().setHours(Integer.parseInt(txtHours.getText()));
        			   removal.setOutcome(cmbOutcome.getSelectedItem().toString());
        			   
        			   
        			   
        			   removalDB.storeRemovalRequest(removal);  //WRITE DATA TO FILE
        			   JOptionPane.showMessageDialog(null," update successfully","Done",JOptionPane.INFORMATION_MESSAGE);
