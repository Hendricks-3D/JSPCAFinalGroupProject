...
public class DeleteCitizen extends JFrame {
	...
	public DeleteCitizen() {
		super("Delete Citizen ");//CALL THE PARENT CLASS DEFAULT CONSTRUCTOR AND PASS TITLE
    	...
    	title = new JLabel("Delete Citizen");
    	...
    	deleteBtn.setBackground(new Color(207, 0, 15));
    		 ...
    		 public void actionPerformed(ActionEvent ae)
    		 {
    			//TODO: ADD APPROPRIATE TRY CATCH (EXCEPTION)
    			 ...
    			 try {
	                   ...
	                   citizenDb = new CitizenDB();
	                   citizenDb.deleteCitizen(citizen);//STORE CITIZEN TO FILE
