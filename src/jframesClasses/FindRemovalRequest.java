...
public class FindRemovalRequest extends JFrame {
    ...
    private JTextField txtMonth,txtDay,txtYear,txtHours,txtMinutes,txtInterNo;
    private JLabel lblMonth,lblDay,lblYear,lblHours,lblMinutes,lblInterNo,lblOutcome;
	...
	public FindRemovalRequest() {
    	...
    	title = new JLabel("Find Removal Request");
    	...
    	findBtn.addActionListener(new ActionListener() 
    	{
    		 public void actionPerformed(ActionEvent ae)
    		 {
               ...
               try 
               {
            	 ...
            	 if(removal.getDate().getMonth()==0||removal.getDate().getDay()==0)
            	 {
            		 JOptionPane.showMessageDialog(null,"Removal request not found","ERROR",JOptionPane.ERROR_MESSAGE);
            	 }
            	 else
            	 {
